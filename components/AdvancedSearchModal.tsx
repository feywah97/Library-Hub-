        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-[10px] font-black text-emerald-800 uppercase tracking-widest px-1">Penulis / Pengarang</label>
              <input 
                type="text"
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-sm transition-all"
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-black text-emerald-800 uppercase tracking-widest px-1">Tahun Terbit</label>
              <input 
                type="number"
                min="1900"
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-black text-emerald-800 uppercase tracking-widest px-1">Topik Spesifik</label>
            <input 
              type="text"
              className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-sm transition-all"
          ...
          <button 
            type="submit"
            className="w-full py-4 bg-[#2D9C6B] text-white font-black rounded-xl shadow-lg hover:bg-[#1B5E20] transition-all border-b-4 border-yellow-500 active:translate-y-1 active:border-b-0 flex items-center justify-center space-x-2"
          >
